  ...
  <div class="col-lg-12">
    ...
    <?php  foreach($posts as $post): ?>
        <div class="row">
            ...
            <h5><?php echo(htmlentities( $post['title'] )); ?> <span style='float:right;'><?php echo(htmlentities( time2str($post['datestamp']) )); ?></span></h5>
            <hr />
            <p><?php echo(htmlentities( substr($post['content'], 0, 500) )); ?> <a href='/post/view/<?php echo(htmlentities( $post['id'] )); ?>'>... read more</a></p>
            </div>
        </div>
    <?php  endForeach; ?>
  </div>
